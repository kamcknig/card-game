Secluded Shrine is an Action-Duration card from Plunder. It is a trasher that is activated when you gain Treasure, and
waits in your play area until that happens.

## Official FAQ

This can trigger on any player's turn.
It triggers even if the player can't or doesn't want to trash anything; they don't have to trash anything, but Secluded
Shrine is done, and is discarded that turn.
