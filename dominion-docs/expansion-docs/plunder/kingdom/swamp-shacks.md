Swamp Shacks is an Action card from Plunder. It is a village that provides a variable number of +Cards, increasing the
more cards you already have in play when you play it.
