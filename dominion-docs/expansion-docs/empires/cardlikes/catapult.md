...
- If the card you trash is a Treasure, each other player discards down to 3 cards in hand; if the card you trash costs $3 or more, each other player gains a Curse; if it is both (e.g. Silver), both things happen; if it is neither, neither thing happens.
