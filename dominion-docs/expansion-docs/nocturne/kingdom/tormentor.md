...
- Cards in play from previous turns are still cards in play; cards you
  played this turn but which are no longer in play (such as a Pixie you trashed) are not in play.

## Other rules clarifications

- If you play a Tormentor but it isn't in play, it still checks the rest of
  your play area to see if there are other cards.
