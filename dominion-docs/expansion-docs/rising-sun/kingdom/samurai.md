Samurai is an Action-Duration-Attack card from Rising Sun. It is a discard attack that you can only play once, but once
you've played it, it gives you +$1 every turn for the rest of the game.
