...
container.register({
  _io: asValue(io),
  _maxPlayers: asValue(6),
  _matchControllerFactory: asClass(MatchControllerFactory).singleton(),
  _matchConfiguratorFactory: asClass(MatchConfiguratorFactory).singleton(),
  _expansionSearchService: asClass(ExpansionSearchService).singleton(),
  _expansionCompatibilityService: asClass(ExpansionCompatibilityService).singleton(),
  _matchRuntimeFactory: asClass(MatchRuntimeFactory).singleton(),
  _matchSocketBindings: asClass(MatchSocketBindings).singleton(),
  _configStore: asClass(FileGameConfigurationStore).singleton(),
  _lobbySocketBindings: asClass(LobbySocketBindings).singleton(),
  _disconnectedPlayerVoteService: asClass(DisconnectedPlayerVoteService).singleton(),
  _playerSessionService: asClass(PlayerSessionService).singleton(),
  _playerRegistryService: asClass(PlayerRegistryService).singleton(),
  _matchStartOrchestrator: asClass(MatchStartOrchestrator).singleton(),
