...
Debug a running game server by inspecting and mutating live debug endpoints, OpenAPI, and runtime log files. Use when prompts mention running-game investigation, such as "In a running game debug why", "i have a game running and", or requests to diagnose behavior using provided game and match IDs.
