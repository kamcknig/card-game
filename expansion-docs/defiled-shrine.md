...
When you gain an Action, move 1VP from its pile to this. When you gain a Curse in your Buy phase, take the  VP from this.
...
- Although Defiled Shrine itself does not place VP tokens on Gathering Action piles, it will still move VP tokens off their piles when you gain one of them.
