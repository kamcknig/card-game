Stowaway is an Action-Duration-Reaction card from Plunder. It a terminal source of duration draw, but can be played
non-terminally when you or anyone else gains a Duration card.
