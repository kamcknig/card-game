...
- Each player has a separate pile of coin tokens on Sinister Plot; keep
  yours by your cube.
- Each turn you either add a token (an unused one, not one from a mat), or
  remove all of your tokens to draw as many cards.
