...
- In general, there is no way to multiply a Night card with a Throne Room
  variant (the exception being calling Royal Carriage on Werewolf).
- Cards that care about specific types will not have their usual effects when
  dealing with Night cards, whether positive (e.g., Ironworks or Magpie) or negative (e.g., Rabble).
- Cards that care about specific phases (e.g., Villa) will not have their
  usual effects in the Night phase. Haunted Woods is particularly brutal, as it prevents you from playing any of your Night cards if you buy anything.

## Official rules

- Nocturne adds Night cards and the Night phase.
- In games using Night cards, the Night phase happens after the Buy phase -
  it goes, Action, Buy, Night, Clean-up.
- In your Night phase, you can play any number of Night cards.

## List of Night cards
- $2 Guardian, Monastery
- $2* Bat
- $3 Changeling, Ghost Town, Night Watchman
- $4 Devil's Workshop, Exorcist
- $4* Ghost
- $5 Cobbler, Crypt, Den of Sin, Vampire, Werewolf
- $6 Raider
